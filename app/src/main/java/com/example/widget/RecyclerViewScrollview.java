...
public class RecyclerViewScrollview extends ScrollView {
    ...
    public void OnScrollBottomListener(OnScrollBottomListener onScrollBottomListener) {
        this.onScrollBottomListener = onScrollBottomListener;
    }

    public void unOnScrollViewScrollToBottom() {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            int scrollY = RecyclerViewScrollview.this.getScrollY();
